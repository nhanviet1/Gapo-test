...
import com.example.newfeeds.detailmodel.MediaData


class ImgDetailAdapter(private val list: List<MediaData>): RecyclerView.Adapter<ImgDetailAdapter.ViewHolder>() {
